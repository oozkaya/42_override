...
int auth(char *login, unsigned int serial)
{
    ...
    if (len > 0x5)
    {
        ptrace(0x0, 0x0, 0x1, 0x0); // PTRACE_TRACEME ?
    }
...
//    0x0804889e <+37>:	    mov    DWORD PTR [esp],0x8048ad4            '*' <repeats 35 times>
...
//    0x080488b6 <+61>:	    mov    DWORD PTR [esp],0x8048ad4            '*' <repeats 35 times>
//    0x080488bd <+68>:	    call   0x8048590 <puts@plt>                 puts('*' <repeats 35 times>)
...
//    0x080488ec <+115>:	mov    DWORD PTR [esp],0x8048ad4            '*' <repeats 35 times>
//    0x080488f3 <+122>:	call   0x8048590 <puts@plt>                 puts('*' <repeats 35 times>)
...
//    0x08048904 <+139>:	mov    DWORD PTR [esp],0x8048ad4            '*' <repeats 35 times>
//    0x0804890b <+146>:	call   0x8048590 <puts@plt>                 puts('*' <repeats 35 times>)
