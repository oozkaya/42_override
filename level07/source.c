...
//    0x08048636 <+6>:	mov    DWORD PTR [ebp-0x10],0x0         # num1
//    0x0804863d <+13>:	mov    DWORD PTR [ebp-0xc],0x0          # num2
...
//    0x08048656 <+38>:	mov    DWORD PTR [ebp-0x10],eax         # num1 = unum();
...
//    0x0804866b <+59>:	mov    DWORD PTR [ebp-0xc],eax          # num2 = get_unum();
//    0x0804866e <+62>:	mov    ecx,DWORD PTR [ebp-0xc]          # num2;
//    0x08048671 <+65>:	mov    edx,0xaaaaaaab
//    0x08048676 <+70>:	mov    eax,ecx
//    0x08048678 <+72>:	mul    edx                              # edx = num2 * 0xaaaaaaab
...
//    0x080486c2 <+146>:	mov    eax,DWORD PTR [ebp-0xc]      # num2
//    0x080486c5 <+149>:	shl    eax,0x2                      # << 2
//    0x080486c8 <+152>:	add    eax,DWORD PTR [ebp+0x8]
//    0x080486cb <+155>:	mov    edx,DWORD PTR [ebp-0x10]     # num1
