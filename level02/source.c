...
int main(int argc, char **argv)
{
    ...
    len_flag = fread(flag, 0x1, 0x29, fd);
    flag[strcspn(flag, "\n")] = '\0';
    if (len_flag != 0x29)
    {
    ...
    puts("*****************************************");
    if (strncpm(flag, password, 0x29) != 0)
    {
        printf("Greetings, %s!\n", username);
        system("/bin/sh");
        return 0;
...
//    0x00000000004008ad <+153>:	mov    QWORD PTR [rbp-0x8],rax              # fd
...
//    0x00000000004008c2 <+174>:	mov    eax,0x400bd0                         # "ERROR: failed to open password file\n"
//    0x00000000004008c7 <+179>:	mov    rcx,rdx
//    0x00000000004008ca <+182>:	mov    edx,0x24
//    0x00000000004008cf <+187>:	mov    esi,0x1
//    0x00000000004008d4 <+192>:	mov    rdi,rax                              # stderr
...
//    0x00000000004008e6 <+210>:	lea    rax,[rbp-0xa0]                       # flag
//    0x00000000004008ed <+217>:	mov    rdx,QWORD PTR [rbp-0x8]              # fd
...
//    0x0000000000400901 <+237>:	call   0x400690 <fread@plt>                 # fread(flag, 0x1, 0x29, fd);
//    0x0000000000400906 <+242>:	mov    DWORD PTR [rbp-0xc],eax              # len_flag = fread()
//    0x0000000000400909 <+245>:	lea    rax,[rbp-0xa0]                       # flag
//    0x0000000000400910 <+252>:	mov    esi,0x400bf5                         # "\n"
//    0x0000000000400915 <+257>:	mov    rdi,rax
//    0x0000000000400918 <+260>:	call   0x4006d0 <strcspn@plt>               # strcspn(flag, "\n");
//    0x000000000040091d <+265>:	mov    BYTE PTR [rbp+rax*1-0xa0],0x0        # flag[strcspn()] = '\0';
...
//    0x0000000000400935 <+289>:	mov    eax,0x400bf8                         # "ERROR: failed to read password file\n"
...
//    0x0000000000400959 <+325>:	mov    eax,0x400bf8                         # "ERROR: failed to read password file\n"
...
//    0x00000000004009d9 <+453>:	call   0x4006f0 <fgets@plt>                 # fgets(username, 0x64, stdin);
//    0x00000000004009de <+458>:	lea    rax,[rbp-0x70]                       # username
//    0x00000000004009e2 <+462>:	mov    esi,0x400bf5                         # "\n"
//    0x00000000004009e7 <+467>:	mov    rdi,rax
//    0x00000000004009ea <+470>:	call   0x4006d0 <strcspn@plt>               # strcspn(username, "\n");
//    0x00000000004009ef <+475>:	mov    BYTE PTR [rbp+rax*1-0x70],0x0        # username[strcspn()] = '\0';
//    0x00000000004009f4 <+480>:	mov    eax,0x400ce8                         # "--[ Password: "
...
//    0x0000000000400a10 <+508>:	lea    rax,[rbp-0x110]                      # password
//    0x0000000000400a17 <+515>:	mov    esi,0x64
//    0x0000000000400a1c <+520>:	mov    rdi,rax
//    0x0000000000400a1f <+523>:	call   0x4006f0 <fgets@plt>                 # fgets(password, 0x64, stdin);
//    0x0000000000400a24 <+528>:	lea    rax,[rbp-0x110]                      # password
//    0x0000000000400a2b <+535>:	mov    esi,0x400bf5                         # "\n"
//    0x0000000000400a30 <+540>:	mov    rdi,rax
//    0x0000000000400a33 <+543>:	call   0x4006d0 <strcspn@plt>               # strcspn(password, "\n");
//    0x0000000000400a38 <+548>:	mov    BYTE PTR [rbp+rax*1-0x110],0x0       # password[strcspn()] = '\0'
//    0x0000000000400a40 <+556>:	mov    edi,0x400cf8                         # '*' <repeats 41 times>
//    0x0000000000400a45 <+561>:	call   0x400680 <puts@plt>                  # puts(*****************************************);
//    0x0000000000400a4a <+566>:	lea    rcx,[rbp-0x110]                      # password
//    0x0000000000400a51 <+573>:	lea    rax,[rbp-0xa0]                       # flag
//    0x0000000000400a58 <+580>:	mov    edx,0x29
//    0x0000000000400a5d <+585>:	mov    rsi,rcx
//    0x0000000000400a60 <+588>:	mov    rdi,rax
//    0x0000000000400a63 <+591>:	call   0x400670 <strncmp@plt>               # strncmp(flag, password, 0x29);
//    0x0000000000400a68 <+596>:	test   eax,eax                              # cmp eax, 0
//    0x0000000000400a6a <+598>:	jne    0x400a96 <main+642>
//    0x0000000000400a6c <+600>:	mov    eax,0x400d22                         # "Greetings, %s!\n"
//    0x0000000000400a71 <+605>:	lea    rdx,[rbp-0x70]                       # username
...
//    0x0000000000400aa7 <+659>:	mov    edi,0x400d3a                         # " does not have access!"
//    0x0000000000400aac <+664>:	call   0x400680 <puts@plt>                  # puts(username);
